  ...
  return (
    ...
    >
      ...
      <View className="flex flex-1 justify-center items-center mb-4">
        <Text className={`text-2xl text-center font-bold mb-2`} style={{ color: provider.textColor }}>
          {provider.name} Payment
        </Text>
        <Text className={`text-base text-center opacity-80 mb-4`} style={{ color: provider.textColor }}>
          {provider.description}
        </Text>
        <View className="flex-row items-center">
          <View className="w-8 h-8 bg-white rounded-full items-center justify-center mr-2">
            <Ionicons name={provider.icon} size={24} color={provider.backgroundColor} />
          </View>
          <Text className="text-sm font-semibold" style={{ color: provider.textColor }}>
