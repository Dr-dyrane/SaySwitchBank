...
const providerPrefixes = {
  '0803': 'mtn', '0806': 'mtn', '0703': 'mtn', '0706': 'mtn', '0813': 'mtn', '0816': 'mtn', '0810': 'mtn', '0814': 'mtn', '0903': 'mtn',
  '0805': 'glo', '0705': 'glo', '0905': 'glo', '0807': 'glo', '0815': 'glo', '0811': 'glo',
  '0802': 'airtel', '0808': 'airtel', '0708': 'airtel', '0812': 'airtel', '0701': 'airtel', '0902': 'airtel', '0907': 'airtel', '0901': 'airtel',
  '0809': '9mobile', '0817': '9mobile', '0818': '9mobile', '0908': '9mobile', '0909': '9mobile'
};

const PhoneSelector = ({ onSelectProvider, onChangePhoneNumber, initialPhoneNumber, initialProvider }) => {
  const [phoneNumber, setPhoneNumber] = useState(initialPhoneNumber || '');
  const [selectedProvider, setSelectedProvider] = useState(initialProvider || serviceProviders.mtn);
